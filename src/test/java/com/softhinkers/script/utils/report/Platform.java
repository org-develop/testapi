package com.softhinkers.script.utils.report;
...
public enum Platform {
     ...
     */
    public static Platform fromString(String name) throws Exception {
        ...
        throw new Exception("Unrecognized platform: " + name);
    }
